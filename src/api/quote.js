 ...
 *   POST /wechat/staff/quote/create/:lead_id   dto.QuoteCreateReq（:lead_id 为**线索 ID**）
 ...
 */
export const createQuote = (leadId, payload) => rpc(API_PATHS.quote.create, payload, leadId)
